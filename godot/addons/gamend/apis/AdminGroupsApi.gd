...
# Operation adminDeleteGroup → DELETE /api/v1/admin/groups/{id}
...
func admin_delete_group(
	...
	var bzz_path := "/api/v1/admin/groups/{id}".replace("{" + "id" + "}", _bzz_urlize_path_param(id))
...
func admin_delete_group_threaded(
	# id: int   Eg: 56
	id: int,
	on_success: Callable = Callable(),  # func(response: ApiApiResponseClient)
	on_failure: Callable = Callable(),  # func(error: ApiApiErrorClient)
	...
	var bzz_callable := Callable(self, "admin_delete_group")
	bzz_callable.bind(
		id,
		on_success,
		on_failure,
...
# Operation adminListGroups → GET /api/v1/admin/groups
# List all groups (admin)
#
# List all groups including hidden. Supports filters.
func admin_list_groups(
	...
	# Compute the URL path to the API resource
	var bzz_path := "/api/v1/admin/groups"
	...
	self._bzz_request(
		bzz_method, bzz_path, bzz_headers, bzz_query, bzz_body,
		func(bzz_response):
			bzz_response.data = AdminListGroups200Response.bzz_denormalize_single(bzz_response.data)
			on_success.call(bzz_response)
			,
		func(bzz_error):
			on_failure.call(bzz_error)
...
func admin_list_groups_threaded(
	# title: String = ""   Eg: title_example
	title = "",
	# type: String = ""   Eg: type_example
	type = "",
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "admin_list_groups")
	bzz_callable.bind(
		title,
		type,
		minMembers,
...
# Operation adminUpdateGroup → PATCH /api/v1/admin/groups/{id}
...
func admin_update_group(
	...
	if not bzz_found_producible_mime:
		...
		error.identifier = "admin_update_group.headers.content_type"
	...
	var bzz_body = null
	bzz_body = adminUpdateGroupRequest

	self._bzz_request(
		bzz_method, bzz_path, bzz_headers, bzz_query, bzz_body,
		func(bzz_response):
			bzz_response.data = AdminUpdateGroup200Response.bzz_denormalize_single(bzz_response.data)
			on_success.call(bzz_response)
			,
		func(bzz_error):
			on_failure.call(bzz_error)
...
func admin_update_group_threaded(
	# id: int   Eg: 56
	id: int,
	# adminUpdateGroupRequest: AdminUpdateGroupRequest
	# Update parameters
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "admin_update_group")
	bzz_callable.bind(
		id,
