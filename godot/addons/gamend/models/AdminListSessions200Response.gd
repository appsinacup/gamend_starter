extends Resource
class_name AdminListSessions200Response
...
# AdminListSessions200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = AdminListSessions200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
