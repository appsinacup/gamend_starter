extends Resource
class_name ListGroupInvitations200Response
...
# ListGroupInvitations200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = ListGroupInvitations200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
