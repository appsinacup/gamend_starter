extends Resource
class_name ListChatMessages200Response
...
# ListChatMessages200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = GetChatMessage200Response.bzz_denormalize_multiple(from_dict["data"])
	if from_dict.has("meta"):
		me.meta = from_dict["meta"]
	return me
