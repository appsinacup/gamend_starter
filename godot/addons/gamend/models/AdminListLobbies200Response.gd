extends Resource
class_name AdminListLobbies200Response
...
# AdminListLobbies200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = AdminListLobbies200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
