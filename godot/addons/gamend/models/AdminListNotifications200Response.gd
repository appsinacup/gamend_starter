extends Resource
class_name AdminListNotifications200Response
...
# AdminListNotifications200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = AdminListNotifications200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
