extends Resource
class_name ListLeaderboards200Response
...
# ListLeaderboards200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = ListLeaderboards200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
