extends Resource
class_name ListGroupMembers200Response
...
# ListGroupMembers200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = ListGroupMembers200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
