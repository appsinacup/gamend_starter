extends Resource
class_name ListMyGroups200ResponseDataInner
...
# ListMyGroups200ResponseDataInner Model
...
@export var type: String = "":
	set(value):
		if str(value) != "" and not (str(value) in __type__allowable__values):
			push_error("ListMyGroups200ResponseDataInner: tried to set property `type` to a value that is not allowed." +
				"  Allowed values: `public`, `private`, `hidden`")
			return
