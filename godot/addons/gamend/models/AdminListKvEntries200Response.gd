extends Resource
class_name AdminListKvEntries200Response
...
# AdminListKvEntries200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = AdminListKvEntries200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
