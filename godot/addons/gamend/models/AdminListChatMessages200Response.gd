extends Resource
class_name AdminListChatMessages200Response
...
# AdminListChatMessages200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = AdminListChatMessages200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
