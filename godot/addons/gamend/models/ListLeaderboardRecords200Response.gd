extends Resource
class_name ListLeaderboardRecords200Response
...
# ListLeaderboardRecords200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = ListLeaderboardRecords200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
