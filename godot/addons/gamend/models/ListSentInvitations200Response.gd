extends Resource
class_name ListSentInvitations200Response
...
# ListSentInvitations200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = ListSentInvitations200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
