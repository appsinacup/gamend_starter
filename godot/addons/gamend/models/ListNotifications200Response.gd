extends Resource
class_name ListNotifications200Response
...
# ListNotifications200Response Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = ListNotifications200ResponseDataInner.bzz_denormalize_multiple(from_dict["data"])
